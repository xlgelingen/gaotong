...
const PAGE = {
    ...
    clone: function () {
        ...
        let itemMargin = parseInt(window.getComputedStyle(teacherCards[0]).marginRight);
        PAGE.data.defaultLength = teacherCards.length - 4;
        PAGE.data.itemWidth = cardItemWidth;
        PAGE.data.itemMargin = itemMargin;
        PAGE.data.translateX = - ((cardItemWidth + itemMargin) * index);
    },
    ...
    goIndex: function (index) {
        ...
        let cardItemWidth = PAGE.data.itemWidth;
        ...
        if (index <= 0) preArrow.style.backgroundColor = '#E2E6EA';
        else preArrow.style.backgroundColor = '#B1BDC6';

        if (index >= swiperLength) nextArrow.style.backgroundColor = '#E2E6EA';
        else nextArrow.style.backgroundColor = '#B1BDC6';

        let itemMargin = PAGE.data.itemMargin;
